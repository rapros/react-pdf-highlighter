...
var PdfAnnotator = function (_Component) {
  ...
  PdfAnnotator.prototype.toggleTextSelection = function toggleTextSelection(toggleState) {
    this.viewer.viewer.classList.toggle("PdfAnnotator--disable-selection", toggleState);
    if (toggleState === true) {
      // Clears existing text selections
      var selection = window.getSelection();
      selection.empty();
  ...
  PdfAnnotator.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      typeof enableAreaSelection === "function" ? _react2.default.createElement(_MouseSelection2.default, {
        ...
        onSelection: function onSelection(startTarget, boundingRect, resetAreaSelection) {
