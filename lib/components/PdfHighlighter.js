...
var PdfHighlighter = function (_Component) {
  ...
  PdfHighlighter.prototype.toggleTextSelection = function toggleTextSelection(toggleState) {
    this.viewer.viewer.classList.toggle("PdfHighlighter--disable-selection", toggleState);
    if (toggleState === true) {
